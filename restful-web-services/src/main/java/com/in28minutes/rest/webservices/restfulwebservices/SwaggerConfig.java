...
public class SwaggerConfig {
	...
	public static final ApiInfo DEFAULT_API_INFO = new 
			ApiInfo("API that will retrieve weather metrics of a specific city", "The “/data” endpoint should return a JSON object that gives the averages of the\r\n" + 
					"following metrics:\r\n" + 
					"o Average temperature (in Celsius) of the next 3 days from today’s date for Day\r\n" + 
					"time (06:00 – 18:00) and Night time (18:00 – 06:00) .\r\n" + 
					"o Average of pressure for the next 3 days from today’s date.", "1.0", "urn:tos",
